...
headers = {
    'Referer': 'http://www.weather.com.cn/weather40d/101200101.shtml',
...
# 根据年、月的信息生成url列表
def generate_url_list(start_date, end_date, city_id = 101200101):
    weather_url_list = []
    dates = []
...
def parser_weather_data(resp):
    ...
    for info in weather_infos:
        with open('weather_wuhan.csv', 'a') as  csv_file:
...
def main():
    with open('weather_wuhan.csv', 'w') as csv_file:
        writer = csv.writer(csv_file)
